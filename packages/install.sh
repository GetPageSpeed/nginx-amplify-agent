...
amplify_hostname=""
api_url="https://amplify.getpagespeed.com:443"
...
# Enable EPEL on EL7 for Python 3 packages not shipped by CentOS base.
enable_epel_el7 () {
...
case "$os" in
    ubuntu|debian)
        ...
        case "$codename" in
            buster|bullseye|bookworm|trixie|bionic|focal|jammy|noble)
                check_python 3
                python_supported=3
                ;;
            *)
